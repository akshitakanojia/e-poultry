    ...
    >
      <ul>
        <li
          ...
          data-thumb="../../assets/images/blur1-100x50.jpg"
          data-rotate={0}
        ...
        >
          <img
            src="images/slider_bg1.jpg"
            alt="poultry-farming-slider-1"
            ...
            >
              ...
              >
                <div
                  ...
                  data-basealign="slide"
                  data-responsive_offset="on"
                  data-frames='[{"delay":"+290","split":"chars","splitdelay":0.05,"speed":550,"frame":"0","from":"y:40px;sX:1.5;sY:1.5;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power4.easeOut"},{"delay":"wait","speed":1000,"frame":"999","to":"sX:1;sY:1;opacity:0;fb:10px;","ease":"Power4.easeOut"}]'
                  data-margintop="[0,0,0,0]"
                  data-marginright="[0,0,0,0]"
                  data-marginbottom="[0,0,0,0]"
                  data-marginleft="[0,0,0,0]"
                ...
                <a
                  href="javascript:;"
                  target="_blank"
                  className="tp-caption rev-btn clv_btn"
                  id="slide-407-layer-4"
                  data-x="['center','center','center','center']"
                  data-hoffset="['0','0','0','0']"
                  data-y="['bottom','bottom','top','top']"
          ...
          <div
            ...
            data-paddingbottom="[0,0,0,0]"
            data-paddingleft="[0,0,0,0]"
            style={{ zIndex: 5, backgroundColor: "rgba(37, 37, 37, 0.7)" }}
          >
            {" "}
          </div>
        </li>
        ...
        >
          <img
            src="images/slider_bg2.jpg"
            alt="poultry-farming-slider-2"
            data-bgposition="center center"
            data-kenburns="on"
            data-duration={20000}
            data-ease="Linear.easeNone"
