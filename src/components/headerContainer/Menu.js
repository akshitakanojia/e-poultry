...
import { toggleSignin, logout } from '../../redux/authentication/authentication.actions'
...
function Menu({ toggleSignin, token, logout, toggleCartHidden, hidden, itemCount }) {
	const [navToggle, setNavToggle] = useState(false)
	return (
		<div className="clv_menu">
			<div className={`clv_menu_nav ${navToggle && "nav_toggle"}`} >
				<ul>
					...
					<li><Link to='/contact-us'>contact us</Link></li>
					{
						token ?
							...
							: <li><a href='javascrpit:;' onClick={toggleSignin}>log in</a></li>
					}
				</ul>
			</div>
